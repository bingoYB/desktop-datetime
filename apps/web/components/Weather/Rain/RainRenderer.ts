...
export default class RainRenderer {
  ...
  textures: { name: string, img: TexImageSource | null }[] = [];
  
  parallaxX: number = 0;
  parallaxY: number = 0;
  stopped: boolean = false;

  constructor(canvas: HTMLCanvasElement, canvasLiquid: HTMLCanvasElement, imageFg: ImageWithSize, imageBg: ImageWithSize, imageShine: TexImageSource | null = null, options: Partial<RainRendererOptions> = {}) {
    this.canvas = canvas;
