...
export function createShader(gl: WebGLRenderingContext, script: string, type: number): WebGLShader | null {
...
export function createTexture(gl: WebGLRenderingContext, source: TexImageSource | null, i: number): WebGLTexture | null {
